...
$post_install_code = $zip_obj->getFromName("Light-PHP-1.8/system/engine/Config.php");
file_put_contents('./system/engine/Config.php', $post_install_code);

$post_install_code = $zip_obj->getFromName("Light-PHP-1.8/system/engine/Console.php");
...
$post_install_code = $zip_obj->getFromName("Light-PHP-1.8/system/engine/Database.php");
...
$post_install_code = $zip_obj->getFromName("Light-PHP-1.8/system/engine/Output.php");
...
$post_install_code = $zip_obj->getFromName("Light-PHP-1.8/system/engine/Session.php");
...
$post_install_code = $zip_obj->getFromName("Light-PHP-1.8/system/engine/Util.php");
